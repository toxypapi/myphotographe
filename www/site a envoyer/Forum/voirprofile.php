...
?> 
	   ...
	   <?php		
		 ...
		 if($data['experience']=="debutant" && $data['je_suis']=="photographe")
			...
			else if($data['experience']=="debutant" && $data['je_suis']=="modele")
		    {
				 echo "Modele Debutant";
			}
			else if($data['experience']=="amateur" && $data['je_suis']=="modele" && $data['sexe']=="homme")
			{
				 echo "Modele Amateur";
		    }
			else if($data['experience']=="amateur" && $data['je_suis']=="modele" && $data['sexe']=="femme")
			{
				 echo "Modele Amatrice";
		    }
			else if($data['experience']=="experimente" && $data['je_suis']=="modele" && $data['sexe']=="homme")
		    {
				 echo "Modele Experiment&eacute;e";
			}
			else if($data['experience']=="experimente" && $data['je_suis']=="modele" && $data['sexe']=="femme")
		    {
				 echo "Modele Experiment&eacute;e";
			}	            	         
?>			
...
?>
	   ...
	   <?php		
		 ...
		 if($data['experience']=="debutant" && $data['je_suis']=="photographe")
			...
			else if($data['experience']=="experimenté" && $data['je_suis']=="modele" && $data['sexe']=="femme")
		    {
				 echo "Modele Experiment&eacute;e";
			}	            	         
?>			
...
<?php
    ...
    case "modifier":
        ...
        echo '<div class="fond"><fieldset class="cro4"><legend ><h2 >Modifier mon profil</h2></legend>';
...
echo'		<u><b>Je suis</u></b><br />';
		...
		<label for="modele">Modele</label><input type="radio" id="je_suis"name="je_suis" value="modele" /> </br>';
		...
		<label for="modele">Modele</label><input type="radio" id="je_suis"name="je_suis" value="modele" checked/> </br>';
		}
?>		
<?php	
...
echo'   <u><b>Informations suppl&eacute;mentaires</u></b><br />       
    ...
    if (!empty($_FILES['avatar']['size']))
    {
        ...
        $maxsize = 30072000000000; //Poid de l'image
        $maxwidth = 1000000000000; //Largeur de l'image
        $maxheight = 100000000000; //Longueur de l'image
